        ...
        <div>
          <div className="px-5 my-5">
            <select
              ...
              id="small"
              className="block w-full p-2 text-sm text-gray-900 border border-orange-500 rounded-lg bg-gray-50"
            >
          ...
          <div>
            <div className="px-5 pb-5">
              <ul className="stories">
                <a className="hover:text-orange-500 translatex" href="">
                  <li>Most Popular</li>
                </a>
                <hr />
                <a className="hover:text-orange-500 translatex" href="">
