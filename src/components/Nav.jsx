...
function Nav({ togglebtn, show }) {
  return (
    <nav className="container mx-auto relative">
      <div
        className={`absolute text-center w-2/5 shadow-md shadow-gray-300${show} md:hidden`}
      >
        <div className={`bg-white h-screen py-5 w-full px-2 `}>
          <div className="font-black text-2xl   content-center mb-4 grid content-center grid-cols-5 justify-items-stretch">
            <a className="grid col-span-4 content-center" href="">
              MEGSPOT
            </a>
            <button
              onClick={togglebtn}
              className="grid content-center text-4xl font-bold"
            >
              <IoMdClose />
            </button>
          </div>
