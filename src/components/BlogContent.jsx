...
import { FaFacebook, FaTwitter, FaPinterest, FaPlus, FaYoutube    } from "react-icons/fa";
    ...
    <div className='container   mx-auto mt-5 w-full'>
        <div className='bg-white w-full px-5 py-5'>
            <div className='flex text-sm'>
                ...
                <a className='hover:text-orange-500' href="">Labtops</a>
            </div>
            <h1 className='font-bold text-3xl'>Here’s What People Think of iOS 13 New Dark Mode</h1>
            <div className='flex justify-between mt-5'>
                <div className='flex'>
                    <img className='rounded-full w-10 h-10 object-cover object-center' src="https://images.unsplash.com/photo-1493863641943-9b68992a8d07?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjZ8fHBlcnNvbnxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" alt="" />
                    <div className='grid content-center ml-5'>
                        <h1>by <span className='text-orange-500'>John Doe</span> - August 02, 2021</h1>
                    </div>
                </div>
            ...
            <div className='w-full my-5'>
                <img className='w-full' src="https://images.unsplash.com/photo-1517430816045-df4b7de11d1d?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8Y29tcHV0ZXJzfGVufDB8fDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" alt="" />
                <div className='mt-5'>
            ...
            <div className='mt-5'>
                <div className='w-full px-5 py-3'>
                    <ul className='ml-5'>
                        ...
                        <li className='list-disc'>The generated Lorem Ipsum is therefore always</li>
                        <li className='list-disc'>Making this the first true generator</li>
                    </ul>
                </div>
            </div>
            <div className='mt-5'>
            ...
            <div className='mt-5'>
                <h3>It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</h3>
            </div>
            <div className='mt-5'>
        ...
        <div className='bg-white w-full mt-5 px-5 py-5 flex'>
            <img className='rounded-full w-20 h-20 object-cover object-center' src="https://images.unsplash.com/photo-1493863641943-9b68992a8d07?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjZ8fHBlcnNvbnxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" alt="" />
            <div className='ml-5'>
        ...
        <div className='bg-white w-full mt-5 flex p-5'>
            <div className='w-full '>
                ...
                <div>
                    <p className='mt-5'>To be published, comments must be reviewed by the administrator. *</p><hr className='mt-5'/>
                    <div className='mt-5'>
                        <div className='flex'>
                            <img className='rounded-full w-10 h-10 object-cover object-center' src="https://images.unsplash.com/photo-1504593811423-6dd665756598?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTR8fHBlcnNvbnxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" alt="" />
                            <div className='ml-3'>
                        ...
                        If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle oftext.
                        </p>
                        <a className='text-orange-500 font-bold text-sm  hover:underline hover:underline-offset-4' href="">Reply</a>
                    </div><hr className='mt-5'/>
                    <div className='mt-5'>
                        <div className='flex'>
                            <img className='rounded-full w-10 h-10 object-cover object-center' src="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTV8fHVzZXJ8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" alt="" />
                            <div className='ml-3'>
