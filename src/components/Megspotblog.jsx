      ...
      <div className="bg-white sm:w-full">
        ...
        <div>
            {dataMegspotBlog.map((items, index) => {
                return(
                    <div key={index} className="p-4 grid gap-3 grid-cols-1 justify-center">
                        <div className="hover:text-orange-500 container mx-auto grid md:grid-cols-8 gap-2 grid-cols-1">
                            ...
                            <div className='mt-3 flex justify-between'>
                                <div>
                                    <a className='text-orange-500 font-semibold' href="">View Story</a>
                                </div>
                                <div className='text-2xl text-orange-500 flex'>
                                    <IoIosChatbubbles />
                                    <span className='text-base text-black font-semibold'>{items.comment}</span>
                                </div>
                            </div>
                            </div>
                        </div>
