        ...
        <div className="footerbg w-full text-white p-5 grid lg:grid-cols-3 gap-5">
          <div>
            <div>
              ...
              <div className="mt-5">
                <a
                  className="flex justify-between mb-1 hover:text-orange-500"
                  href=""
                >
                  Gadgats <span className="text-gray-400">(3)</span>
                </a>
                <a
                  className="flex justify-between mb-1 hover:text-orange-500"
                  href=""
                >
                  Podcasts <span className="text-gray-400">(3)</span>
                </a>
                <a
                  className="flex justify-between mb-1 hover:text-orange-500"
                  href=""
                >
                  Review <span className="text-gray-400">(3)</span>
                </a>
              </div>
            </div>
            <div className="mt-5">
              ...
              <div className="mt-2">
                <button className="btncolormain px-3 rounded-xl mr-2 my-2 hover:text-orange-500">
                  Cars
                </button>
                <button className="btncolormain px-3 rounded-xl mr-2 my-2 hover:text-orange-500">
                  Gadgets
